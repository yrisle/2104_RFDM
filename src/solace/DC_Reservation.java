 ...
 */
public class DC_Reservation extends javax.swing.JFrame {

    /**
     * Creates new form DC_Reservation
     */
    public DC_Reservation() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("You are currently ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DC_Reservation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DC_Reservation().setVisible(true);
            }
        });
    }
